...
The aim of this methodology is to obtain filtered, screened anf filled data from the flux towers.

# The initial level of this data is a high frequency raw data that have multiple errors and gaps. 
